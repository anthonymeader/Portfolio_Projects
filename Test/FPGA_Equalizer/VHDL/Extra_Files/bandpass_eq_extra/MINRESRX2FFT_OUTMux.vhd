-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Antho\Desktop\EELE_468\eq\hdlsrc\bandpass_eq\MINRESRX2FFT_OUTMux.vhd
-- 
...
-- Source Path: bandpass_eq/fftAnalysisSynthesis/analysis/FFT/MINRESRX2FFT_OUTMux
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MINRESRX2FFT_OUTMux IS
  PORT( clk                               :   IN    std_logic;
        ...
        vldOut                            :   IN    std_logic;
        dOut_re                           :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En23
...
ARCHITECTURE rtl OF MINRESRX2FFT_OUTMux IS
  ...
  SIGNAL minResRX2FFTOutMux_doutReg_re_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL minResRX2FFTOutMux_doutReg_im_next : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL dOut_re_tmp                      : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL dOut_im_tmp                      : signed(31 DOWNTO 0);  -- sfix32_En23
