-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Antho\Desktop\EELE_468\eq\hdlsrc\bandpass_eq\MINRESRX2FFT_CTRL_block.vhd
-- 
...
-- Source Path: bandpass_eq/fftAnalysisSynthesis/synthesis/iFFT/MINRESRX2FFT_CTRL
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF MINRESRX2FFT_CTRL_block IS
  ...
  SIGNAL stgOut1_re_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL stgOut1_im_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL stgOut2_re_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL stgOut2_im_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL minResRX2FFTCtrl_dOut1Re_Reg_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL minResRX2FFTCtrl_dOut2Re_Reg_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL minResRX2FFTCtrl_dOut1Im_Reg_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL minResRX2FFTCtrl_dOut2Im_Reg_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL minResRX2FFTCtrl_xSample_re_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL minResRX2FFTCtrl_xSample_im_next : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL dMemIn1_re_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL dMemIn1_im_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL dMemIn2_re_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL dMemIn2_im_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
