	soc_system_bandpassEQ u0 (
		...
		.output_sclk                     (<connected-to-output_sclk>),                     //                 output.sclk
		.output_cs_n                     (<connected-to-output_cs_n>),                     //                       .cs_n
		.output_dout                     (<connected-to-output_dout>),                     //                       .dout
		.output_din                      (<connected-to-output_din>)                       //                       .din
	);
