-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Antho\Desktop\EELE_468\eq\hdlsrc\bandpass_eq\MINRESRX2FFT_MEMORY_block.vhd
-- 
...
-- Source Path: bandpass_eq/fftAnalysisSynthesis/synthesis/iFFT/MINRESRX2FFT_MEMORY
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF MINRESRX2FFT_MEMORY_block IS
  ...
  -- Signals
  SIGNAL dMemIn1_re_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL intdelay_reg                     : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL wrData01Dly_re                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL stage_unsigned                   : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL dMemIn2_re_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL intdelay_reg_1                   : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL wrData10Dly_re                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL dMemIn2_im_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL intdelay_reg_2                   : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL wrData10Dly_im                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL intdelay_reg_3                   : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL wrData11Dly_re                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL intdelay_reg_4                   : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL wrData11Dly_im                   : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL rdData11_im_signed               : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL rdData11_re                      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL rdData11_re_signed               : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL wrEnb10                          : std_logic;
  SIGNAL rdData10_im                      : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL rdData10_im_signed               : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL rdData10_re_signed               : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL dMemOut2_re_tmp                  : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL dMemOut2_im_tmp                  : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL dMemIn1_im_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL intdelay_reg_5                   : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL wrData01Dly_im                   : signed(31 DOWNTO 0);  -- sfix32_En23
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_5 <= (OTHERS => to_signed(0, 32));
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
