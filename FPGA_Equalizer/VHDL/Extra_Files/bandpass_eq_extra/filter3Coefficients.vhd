-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Antho\Desktop\EELE_468\eq\hdlsrc\bandpass_eq\filter3Coefficients.vhd
-- 
...
-- Source Path: bandpass_eq/fftAnalysisSynthesis/frequencyDomainProcessing/applyComplexGains/fftFilterCoefficients/filterChoice/filter3Coefficients
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF filter3Coefficients IS
  ...
  -- Constants
  CONSTANT filter3RealCoefficients_table_data : vector_of_signed16(0 TO 127) := 
    (to_signed(16#0000#, 16), to_signed(16#0000#, 16), to_signed(16#0000#, 16), to_signed(16#0000#, 16),
     to_signed(16#0000#, 16), to_signed(16#0000#, 16), to_signed(16#0000#, 16), to_signed(16#0000#, 16),
     to_signed(16#0000#, 16), to_signed(16#0000#, 16), to_signed(16#0000#, 16), to_signed(16#0100#, 16),
...
BEGIN
  ...
  filter3RealCoefficients_index <= to_signed(16#0000007F#, 32) WHEN ROMindex_signed > to_signed(16#0000007F#, 10) ELSE
