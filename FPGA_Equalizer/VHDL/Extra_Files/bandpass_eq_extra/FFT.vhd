-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Antho\Desktop\EELE_468\eq\hdlsrc\bandpass_eq\FFT.vhd
-- 
...
-- 
-- Module: FFT
-- Source Path: bandpass_eq/fftAnalysisSynthesis/analysis/FFT
-- Hierarchy Level: 2
-- 
-- FFT
-- 
...
ARCHITECTURE rtl OF FFT IS
  ...
  SIGNAL dtc_re                           : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL dtc_im                           : signed(31 DOWNTO 0);  -- sfix32_En23
...
BEGIN
  ...
  u_MinResRX2FFT_BTFSEL : MINRESRX2FFT_BTFSEL
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_1_re => std_logic_vector(dtc_re),  -- sfix32_En23
              din_1_im => std_logic_vector(dtc_im),  -- sfix32_En23
              validIn => validIn,
              rdy => rdy,
              dMemOut1_re => dMemOut1_re,  -- sfix32_En23
              dMemOut1_im => dMemOut1_im,  -- sfix32_En23
  ...
  dtc_re <= resize(dataIn_signed, 32);
