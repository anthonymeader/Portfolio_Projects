-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Antho\Desktop\EELE_468\eq\hdlsrc\bandpass_eq\Complex4Multiply_block.vhd
-- 
...
-- Source Path: bandpass_eq/fftAnalysisSynthesis/synthesis/iFFT/MINRESRX2_BUTTERFLY/Complex4Multiply
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply_block IS
  ...
  SIGNAL din_re_reg                       : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL btfIn2_im_signed                 : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL din_im_reg                       : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL prod1_re                         : signed(63 DOWNTO 0) := to_signed(0, 64);  -- sfix64_En53
  SIGNAL prod1_im                         : signed(63 DOWNTO 0) := to_signed(0, 64);  -- sfix64_En53
  SIGNAL prod2_re                         : signed(63 DOWNTO 0) := to_signed(0, 64);  -- sfix64_En53
  SIGNAL prod2_im                         : signed(63 DOWNTO 0) := to_signed(0, 64);  -- sfix64_En53
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Complex4Add_sub_cast             : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Complex4Add_sub_cast_1           : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Complex4Add_add_cast             : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL Complex4Add_add_cast_1           : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL mulResFP_re                      : signed(64 DOWNTO 0);  -- sfix65_En53
  SIGNAL mulResFP_im                      : signed(64 DOWNTO 0);  -- sfix65_En53
