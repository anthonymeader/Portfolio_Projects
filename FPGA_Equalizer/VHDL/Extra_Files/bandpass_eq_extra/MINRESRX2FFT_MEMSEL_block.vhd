-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Antho\Desktop\EELE_468\eq\hdlsrc\bandpass_eq\MINRESRX2FFT_MEMSEL_block.vhd
-- 
...
-- Source Path: bandpass_eq/fftAnalysisSynthesis/synthesis/iFFT/MINRESRX2FFT_MEMSEL
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF MINRESRX2FFT_MEMSEL_block IS
  ...
  -- Signals
  SIGNAL btfOut1_re_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL btfOut1_im_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL btfOut2_re_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL btfOut2_im_signed                : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL MINRESRX2FFTMEMSEL_stgOut1Reg_re_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL MINRESRX2FFTMEMSEL_stgOut1Reg_im_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL MINRESRX2FFTMEMSEL_stgOut2Reg_re_next : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL MINRESRX2FFTMEMSEL_stgOut2Reg_im_next : signed(31 DOWNTO 0);  -- sfix32_En23
  ...
  SIGNAL stgOut1_re_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL stgOut1_im_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL stgOut2_re_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL stgOut2_im_tmp                   : signed(31 DOWNTO 0);  -- sfix32_En23
